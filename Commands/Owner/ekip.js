...
class Ekip extends Command {
    ...
    async run(message, args, perm) {
        let embed = new MessageEmbed().setColor("RANDOM").setFooter("Can").setAuthor(message.member.displayName, message.author.avatarURL({ dynamic: true }))
